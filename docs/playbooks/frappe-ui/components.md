---
type: Reference
title: "Frappe UI Components Reference"
description: "Component catalog, prop contracts, and usage examples for frappe-ui."
tags: [reference, frappe-ui, frontend, components]
---
