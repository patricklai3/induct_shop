...
### Added
- Context-aware vehicle filtering to the Service Parts Selector.
...
### Changed
- Refactored service part association logic to use one-to-many relationship.
...
### Fixed
- Improved API performance by caching `is_stock_item` lookup values during service part selection.
